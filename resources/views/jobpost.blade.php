        ...
        <div class="container register-form" id="main">
            ...
            <div class="form">
                ...
                <div class="form-content">
                    <div class="row ">
                        ...
                        <form method="POST" action="{{url('jobpost-form')}}">
                            ...
                            <label><h4 class="title">Job status</h4></label><br>
                        ...
                        <input type="radio" name='job_stat' value="0">Unpublished<br/>
                            ...
                            <div class="form-group">
                                ...
                                <label><h4 class="title">Job title</h4></label>
                                <input type="text" name="job_title" placeholder="Job title *"  class="form-control" class="@error('title') is-invalid @enderror form-control"/>
                                @error('title')
                ...
                @enderror
                            ...
                            <div class="form-group">
                            <label><h4 class="title">Job category</h4></label><br>
                        ...
                        <input type="radio" name='job_cat' value="Both"> Both<br/>
                            ...
                            <div class="form-group">
                            <label><h4 class="title">Job Description</h4></label>
